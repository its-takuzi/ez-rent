...
font-family: 'Montserrat', sans-serif;">
    ...
    <div class="container d-flex justify-content-center align-items-center hv-100">
        <div class="card mt-5 mb-5" style="width: 40%; background-color: rgba(255, 255, 255, 0.8);">
            <div class="card-body p-4">
                <h3 class="card-title text-center">Register</h3>
                <form action="{{ route('posta') }}" method="POST"> @csrf <div class="form-group mt-4"> <label
                    ...
                    <div class="form-select mt-1">
                        <label for="level" class="text-secondary">Level Anda</label>
                        <select id="level" name="level" class="form-control">
                            <option selected disabled>Pilih level Anda</option>
                            <option value="admin">Admin</option>
                            <option value="user">User</option>
                            <option value="admin_rental">Admin_rental</option>
                        </select>
                        <span class="text-danger">
                            @error('user_level')
                                {{ $message }}
                    ...
                    <div class="form-group mt-1"> <label class="text-secondary">Password Anda</label> <input
                            ...
                            name="password"> <span class="text-danger"> @error('password')
                                {{ $message }}
                            @enderror </span> </div><br>
                    <div class="form-group mt-1"> <label class="text-secondary">Konfirmasi Password Anda</label>
