...
<body style="background-color: rgba(193, 193, 193, 0.626) ; font-family: 'Montserrat', sans-serif;">
                ...
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <form action="{{ route('rental.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-3">
                                <label class="font-weight-bold">id pemilik rental</label>
                                <input type="text" class="form-control @error('user_id') is-invalid @enderror"
                                    name="user_id" value="{{ old('user_id') }}" placeholder="Masukkan Judul Post">
